...
I remember attending training for AEM(R) back in the CQ5.3-5.4 days.
...
By recognizing some of the warts, AEM(R) decided to create new languages & approaches that wouldn't have the same problems.
...
But I believe AEM(R) is disingenious when they sell Sightly as faster than JSP development when Java classes must be built and deployed as bundles before the new HTML templates can be built.
