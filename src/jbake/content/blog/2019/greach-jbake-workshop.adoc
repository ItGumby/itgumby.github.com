= JBake workshop at GreachConf
2019-11-26
:jbake-type: post
:jbake-status: draft
:jbake-tags: blog,asciidoc,jbake
:idprefix:

== JBake https://jbake.org/docs/2.6.4/#data_model[Data Model]
...
[source, java]
----
include::{test}/greach/workshop/oss/LibraryTest.groovy[]
----
```
